...
{ 
	struct User users[5] = { 
		{ "Arpan", "dasarpan" }, { "Aparajita", "aparajita11" }, 
		{ "Sambeet", "sambeet12" }, { "Sushree", "Sush06" }, 
		{ "Mahesh", "mahesh09" }, 
	}; 
	int numUsers = 5; 
	struct Bus buses[3] = { 
		{ 101, "Bhubaneswar", "Cuttack", 50, 50, 25.0 }, 
		{ 102, "Jajpur", "Bhadrak", 40, 40, 20.0 }, 
		{ 103, "Balesore", "Jaleswar", 30, 30, 15.0 }, 
	}; 
	int numBuses = 3; 
